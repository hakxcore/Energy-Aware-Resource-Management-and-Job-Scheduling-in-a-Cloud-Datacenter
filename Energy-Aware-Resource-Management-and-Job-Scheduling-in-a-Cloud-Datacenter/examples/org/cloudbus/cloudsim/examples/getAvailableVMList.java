...
//		Log.printLine("> Result of completely created VM's" );
//		Log.printLine("*******************************");
//		for(Vm v : finalVmList) {
//			Log.printLine( vmNo +indent+indent+ v.getUid() +indent + v.getVmm()+ indent + v.getId() + indent + v.getCurrentAllocatedSize() + indent + v.getCurrentAllocatedRam() + indent + v.getCurrentRequestedTotalMips());
//			vmNo++;
//		}
//		Log.printLine("*******************************");
//		Log.printLine("");
