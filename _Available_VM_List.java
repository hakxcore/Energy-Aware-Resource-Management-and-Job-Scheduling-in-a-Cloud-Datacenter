...
public class _Available_VM_List  {
...
{
 Log.printLine( c.getCloudletId()+indent+indent+indent +indent+ x1(Cloudlet_type)+indent+indent+indent+c.getVmId() + indent+indent+indent +dft.format(c.getActualCPUTime()) +indent+ dft.format(c.getActualCPUTime())+ indent +indent+ dft.format(c.getFinishTime()));
}
